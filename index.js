...
//
const BotName = 'POKS BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/poukes_?igshid=17tqu48dmdxvu'; // Nama Instagramlu cok
const whatsapplu = '0852-5962-2026'; // Nomor whatsapplu cok
const kapanbotaktif = 'TERGANTUNG'; // Kapan bot lu aktif
const grupch1 = 'BELUM BUAT'; // OFFICIAL GRUP LU 1
const grupch2 = 'BELUM BUAT'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @poukes_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @poukes`)
})
